...
class HomePage extends BasePage {
    ...
    constructor(page: Page) {
        ...
        this.testCasesBtn = page.getByRole('button', { name: 'Test Cases' });
        ...
        this.homeIcon = page.locator('#header .fa-home');
        // this.navBarText = page.locator('//*[@class="nav navbar-nav"]/li/a');
        this.navBarText = page.locator('.nav.navbar-nav li a');
    ...
    async getNavBarText() {
        ...
        const cleanedTexts = navTexts.map(text => text.trim().replace(/[^a-zA-Z0-9\s\/\\]/g, '').trim());
